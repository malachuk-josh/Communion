...
const dictionaries = {
  en: {
    ...
    "session.quickCreateHint": "Create the meeting there, then paste its link above. FaceTime: create a link in the FaceTime app.",
    "common.save": "Save",
  ...
  es: {
    ...
    "session.quickCreateHint": "Crea la reunión allí y luego pega su enlace arriba. FaceTime: crea un enlace en la app FaceTime.",
    "common.save": "Guardar",
